...
var openFB = ( function() {
        ...
        var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth', FB_LOGOUT_URL = 'https://www.facebook.com/logout.php',

        // By default we store fbtoken in sessionStorage. This can be overridden in init()
        tokenStore = window.sessionStorage, fbAppId, context = window.location.pathname.substring(0, window.location.pathname.indexOf("/", 2)), baseURL = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : '') + context, oauthRedirectURL = baseURL + '/oauthcallback.html', logoutRedirectURL = baseURL + '/logoutcallback.html',
        ...
        console.log(oauthRedirectURL); // check if oautchRedictURL is correct
        console.log(logoutRedirectURL); // check if oautchRedictURL is correct
        ...
        function api(obj) {
            ...
            var method = obj.method || 'GET', params = obj.params || {}, xhr = new XMLHttpRequest(), url;
